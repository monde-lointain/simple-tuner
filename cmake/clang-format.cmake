...
#
# You can completely override the default values by setting the variables above.
...
if(CLANG_FORMAT)
  ...
  if(NOT CLANG_FORMAT_EXCLUDE_DIRS)
    set(CLANG_FORMAT_EXCLUDE_DIRS "" CACHE STRING "CMake list of directories to exclude from clang-format.")
  endif()
